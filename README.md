...
网站核心气质是：名门山门、清雅江湖、温暖港湾、来去自由、有界有礼。当前版本已经统一前台、问云小院和后台的视觉系统，使用远山山门、云雾、宣纸、玉石青、墨蓝、朱砂印和鎏金细线形成“名门正派”的第一印象。
...
│  ├─ wenyun-hero.png              # 旧版首页山门主视觉，保留兼容
│  └─ visual/                      # 新版名门山门视觉资产
...
│  │  ├─ GateHero.tsx              # 名门山门首屏组件
│  │  ├─ LoginRequiredNotice.tsx   # 需要登录时的统一提醒和登录入口
│  │  ├─ PageShell.tsx             # 前台页面统一外壳
│  │  ├─ RitualCard.tsx            # 仪式感宣纸卡片
│  │  └─ WorkbenchFrame.tsx        # 小院和后台统一工作台外壳
