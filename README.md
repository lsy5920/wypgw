...
1. 打开 `/join`。
2. 页面会先显示精美的折叠登记入口，点击“展开填写”后再填写名帖。
...
4. 全部作答后点击“交卷并记录成绩”。
5. 90 到 100 分表示深知门风，可登记入册。
6. 80 到 89 分表示基本明规，可登记入册。
7. 70 到 79 分建议执事说明金典重点后，再决定是否入册。
8. 70 分以下建议暂缓入册，重读金典后再考。
9. 系统会保存每次考核记录，小院和后台展示最新一次结果，名册登记也只看最新一次是否合格。
