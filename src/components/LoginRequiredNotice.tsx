...
export function LoginRequiredNotice({ title, message }: LoginRequiredNoticeProps) {
  return (
    <div className="login-required-notice rounded-lg border border-[#d6aa54]/38 bg-[#fff8e8]/88 p-4 text-sm leading-7 text-[#526461] shadow-xl shadow-[#102a31]/8 backdrop-blur">
