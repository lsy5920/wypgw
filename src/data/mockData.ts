...
export const mockApplications: JoinApplication[] = [
  {
    ...
    public_story: '愿意一起守护门派氛围。',
    raw_story: '愿意一起守护门派氛围。',
    tags: '写字、饮茶、演示数据',
    bond_status: '静修旁观',
  ...
  },
  {
    ...
    raw_region: '苏州',
    motto: '愿意做一点温暖的小事。',
    public_story: '愿意提醒大家守住边界。',
    raw_story: '愿意提醒大家守住边界。',
    tags: '护灯、演示数据',
    bond_status: '静修旁观',
  ...
  },
  {
    ...
    public_story: '喜欢清风和安静的文字。',
    raw_story: '喜欢清风和安静的文字。',
    tags: '写文、演示数据',
    bond_status: '寻同路人',
...
export const mockRosterEntries: RosterEntry[] = mockApplications
  ...
  .map((item) => ({
    ...
    roster_serial: item.roster_serial,
